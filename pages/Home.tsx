        ...
        {navBoxes.map((box, idx) => {
          ...
          return (
            <Link
              ...
              to={box.path}
              style={cyberStyle}
              className={`group relative flex flex-col items-center justify-center p-6 border transition-all duration-300 hover:scale-[1.02] active:scale-95 ${themeConfig.styles.radius} ${theme !== 'Cyber OS' ? `${themeConfig.styles.cardBg} ${themeConfig.styles.border} ${themeConfig.styles.textMain} ${themeConfig.styles.shadow}` : 'hover:bg-opacity-80'}`}
            >
              <box.icon
                size={28}
